            ...
            <div class="card-body">
              <form action="simpanmember.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="id_member" placeholder="Masukkan id_member" class="form-control">
                </div>

                <div class="form-group">
                  <label>nama_member</label>
                  <input type="text" name="nama_member" placeholder="Masukkan nama_member" class="form-control">
                </div>
